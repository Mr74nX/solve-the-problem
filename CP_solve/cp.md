...
C++
cout << fixed << setprecision(2) << your_ans << endl; // ২ ঘর পর্যন্ত দেখাবে
...
### কী কী পরিবর্তন ও সুন্দর করা হয়েছে:
১. **কোড ব্লক ফরম্যাটিং:** সবগুলো কোড লজিককে প্রপার ```cpp ব্লকের ভেতরে রাখা হয়েছে যাতে আপনার ফাইলে এটি দেখতে চমৎকার লাগে।
২. **ভেরিয়েবল নেমিং:** `even-count` এর জায়গায় স্ট্যান্ডার্ড প্রোগ্রামিং প্র্যাকটিস মেনে `even_count` (আন্ডারস্কোর) ব্যবহার করা হয়েছে।
৩. **পাওয়ার ফাংশন:** কিউব এবং জ্যামিতিক ধারার বর্গের ক্ষেত্রে C++ এর `pow()` ফাংশন ফরম্যাট যুক্ত করা হয়েছে। 
৪. **ব্র্যাকেটের সমতা:** সি++ এ কোড যেন ক্লিন দেখায় সেভাবে ব্র্যাকেটগুলো সাজানো হয়েছে।
